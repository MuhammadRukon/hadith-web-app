...
const Card = ({ book }) => {
  ...
  console.log(book)
  return (
    <div className="card bg-[#fff9ef] h-full dark:bg-stone-800 dark:text-[#fefdf8] hover:scale-105 transform duration-150 shadow-[0_6px_15px_rgba(0,0,0,0.1)] text-[#0e1037]">
